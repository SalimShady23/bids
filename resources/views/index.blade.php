...
<body>
    ...
    <section class="banner-section-2 bg_img" data-background="{{ url('/assets/images/banner/banner-bg-3.png') }}">
        <div class="container">
        ...
        <div class="banner-shape-2 d-none d-lg-block">
            <img src="{{ url('/assets/css/img/banner-shape-3.png') }}" alt="css">
        </div>
    </section>
            ...
            <div class="m--15">
                <div class="browse-slider owl-theme owl-carousel">
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/01.png') }}" alt="auction">
                        <span class="info">Vehicles</span>
                    </a>
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/02.png') }}" alt="auction">
                        <span class="info">Jewelry</span>
                    </a>
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/03.png') }}" alt="auction">
                        <span class="info">Watches</span>
                    </a>
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/04.png') }}" alt="auction">
                        <span class="info">Electronics</span>
                    </a>
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/05.png') }}" alt="auction">
                        <span class="info">Sports</span>
                    </a>
                    <a href="#0" class="browse-item">
                        <img src="{{ url('/assets/images/auction/06.png') }}" alt="auction">
    ...
    <section class="feature-auction-section padding-bottom padding-top bg_img" data-background="{{ url('/assets/images/auction/featured/featured-bg-1.jpg') }}">
        <div class="container">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/car/auction-1.jpg') }}" alt="jewelry"></a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/jewelry/auction-2.jpg') }}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/watches/auction-2.jpg') }}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
            ...
            <div class="auction-wrapper-5 m--15">
                <div class="auction-item-5 time">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-1.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="auction-item-5 live">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-2.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 buy">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-3.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 time">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-4.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 buy">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-5.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 live">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-6.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 time">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-7.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                ...
                <div class="auction-item-5 live">
                    <div class="auction-inner">
                        ...
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{ url('/assets/images/auction/upcoming/upcoming-8.png') }}" alt="upcoming"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
    ...
    <section class="how-video-section pos-rel">
        <div class="popular-bg bg_img" data-background="{{ url('/assets/images/auction/popular/popular-bg2.png') }}"></div>
        <div class="how-video-shape bg_img d-none d-md-block" data-background="{{ url('/assets/css/img/how-video.png') }}"></div>
        <div class="container">
            ...
            <div class="how-wrapper section-bg shadow-style">
                ...
                <div class="row justify-content-center mb--40">
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            <div class="how-thumb">
                                <img src="{{ url('/assets/images/how/how1.png') }}" alt="how">
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            <div class="how-thumb">
                                <img src="{{ url('/assets/images/how/how2.png') }}" alt="how">
                            </div>
                            <div class="how-content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            <div class="how-thumb">
                                <img src="{{ url('/assets/images/how/how3.png') }}" alt="how">
                            </div>
                            <div class="how-content">
    ...
    <section class="call-in-section padding-top">
        <div class="container">
            <div class="call-wrapper cl-white bg_img" data-background="{{ url('/assets/images/call-in/call-bg.png') }}">
                <div class="section-header">
                ...
                <div class="client-slider owl-theme owl-carousel">
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{ url('/assets/images/client/client01.png') }}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{ url('/assets/images/client/client02.png') }}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{ url('/assets/images/client/client03.png') }}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                ...
                <div class="row mb--60">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                <li>
                                    <a href="#0"><i class="fas fa-phone-alt"></i>0712 345 678</a>
                                </li>
                                <li>
                                    <a href="#0"><i class="fas fa-blender-phone"></i>0712 345 678</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-location-arrow"></i>ifm posta</a>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="copyright-area">
                    <div class="footer-bottom-wrapper">
                        <div class="logo">
                            <a href="index.html"><img src="{{ url('/assets/images/logo/foooter-logo.png') }}" alt="logo"></a>
                        </div>
                        ...
                        <div class="copyright"><p>&copy; Copyright 2022 | <a href="#0">EasyBids</a> By <a href="#0">BCS 3</a></p></div>
                    </div>
                </div>
            </div>
        </div>
