...
<head>
    ...
    <title>EasyBids - My Auctions</title>
                ...
                <div class="col-sm-10 col-md-7 col-lg-4">
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        ...
                        <ul class="dashboard-menu">
                            ...
                            <li>
                                <a href="/my-auctions" class="active"><i class="flaticon-auction"></i>My auctions</a>
                            </li>
                            <li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="upcoming">
                                        ...
                                        <div class="col-sm-10 col-md-6">
                                            <div class="auction-item-2">
                                                <div class="auction-thumb">
                                                    <a href="product-details.html"><img src="/image/{{ $auction->product_image }}"></a>
                                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                                </div>
                                                <div class="auction-content">
                                                    <h6 class="title">
                                                        <a href="#0">{{ $auction->product_name }}</a>
                                                    </h6>
                                                    <div class="bid-area">
                                                        ...
                                                        <div class="bid-amount">
                                                            ...
                                                            <div class="amount-content">
                                                                @if($auction->buy_now == 1)
                                                                    ...
                                                                    <div class="amount">{{ $auction->buy_now_price }}</div>
                                                                @else
                                                    ...
                                                    <div class="countdown-area">
                                                        ...
                                                        <span class="total-bids">
                                                            ...
                                                            @if($auction->buy_now_status == 0)
                                                                0 buy
                                                            @elseif($auction->buy_now_status == 1)
                                                                1 buy 
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <div class="text-center">
                                                        <a href="/view-auction/{{ $auction->id }}" class="custom-button">View auction</a>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                ...
                                @else
                                    ...
                                    There are no recent auctions created by you, add listing now to start auctioning your items and enjoy easy bids.
                                    </div>
