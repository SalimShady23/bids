                ...
                <div class="left-side">
                    ...
                    <form class="login-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-30">
                            ...
                            <input type="password" name="password" autocomplete="new-password" id="login-pass" placeholder="Password">
                        ...
                        <div class="form-group checkgroup mb-30">
                            <input type="checkbox" name="terms" id="check"><label for="check">The EasyBids Terms of Use apply</label>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="a1c9c4cdd1e1c4cfc6ced5c9c4ccc48fc2cecc">[email&#160;protected]</span></a>
                                </li>
                                <li>
