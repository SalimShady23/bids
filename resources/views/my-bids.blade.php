                ...
                <div class="col-sm-10 col-md-7 col-lg-4">
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        ...
                        <ul class="dashboard-menu">
                            ...
                            <li>
                                <a href="/my-bids" class="active"><i class="flaticon-auction"></i>My Bids</a>
                            </li>
                            <li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="upcoming">
                                        ...
                                        <div class="col-sm-10 col-md-6">
                                            <div class="auction-item-2">
                                                <div class="auction-thumb">
                                                    <a href="product-details.html"><img src="/image/{{ $bid->product_image }}"></a>
                                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                                </div>
                                                <div class="auction-content">
                                                    <h6 class="title">
                                                        <a href="#0">{{ $bid->product_name }}</a>
                                                    </h6>
                                                    <div class="bid-area">
                                                        <div class="bid-amount">
                                                            ...
                                                            <div class="amount-content">
                                                                ...
                                                                <div class="amount">{{ number_format($bid->current_bid) }} TZS</div>
                                                            </div>
                                                        </div>
                                                        <div class="bid-amount">
                                                            <div class="icon">
                                                            ...
                                                            <div class="amount-content">
                                                                    ...
                                                                    <div class="amount">{{ number_format($bid->bid_amount) }} TZS</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        <a href="/view-auction/{{ $bid->id }}" class="custom-button">View auction</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @else
                                    ...
                                    There are no recent auctions bidded by you, visit the auction page and start bidding.
                                    </div>
